...
import type { BaseUrlResolveHandler, I18nRoutingOptions, LocaleObject, Strategies } from 'vue-i18n-routing'
...
export function toRawRoute(maybeRoute: Ref<RouteLocationNormalizedLoaded>): RouteLocationNormalizedLoaded {
  return unref(maybeRoute)
}
