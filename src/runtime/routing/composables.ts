...
import type { RouteLocation, RouteLocationRaw, RouteLocationNormalizedLoaded, Router } from 'vue-router'
 ...
 * @public
 */
export type LocalePathFunction = (route: RouteLocation, locale?: Locale) => string
